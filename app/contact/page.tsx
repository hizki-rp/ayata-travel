...
const Contact = () => {
    return (
        <section className="min-h-screen bg-gray-100 py-12 pb-[200]" id="contact">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-gray-100 p-8 rounded-lg shadow-md">
                        ...
                        <div className="mt-8">
                            ...
                            <a href="https://www.google.com/maps/place/Addis+Ababa,+Ethiopia" className="w-full h-48 bg-gray-300 rounded-lg flex items-center justify-center">
                                <p className="text-gray-500">View Location on Google Maps</p>
                            </a>
                        </div>
                    </div>
                    {/* Contact Form */}
